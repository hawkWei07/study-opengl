...
/**
 * Created by kehaowei on 16/9/29.
 */
...
// Set the background clear color to black.
        ...
        // Load the texture
        mBrickDataHandle = TextureHelper.loadTexture(mActivityContext, R.drawable.stone_wall_public_domain, false);
        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);

        mGrassDataHandle = TextureHelper.loadTexture(mActivityContext, R.drawable.noisy_grass_public_domain, false);
        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);
