...
import cn.hawk.opengl.common.RawResourceReader;
import cn.hawk.opengl.common.ShaderHelper;
import cn.hawk.opengl.common.TextureHelper;
...
public class LessonFourRenderer implements GLSurfaceView.Renderer {
    ...
    /**
     * This will used to pass in model color information.
     */
    private int mColorHandle;

    /**
     * This will used to pass in model normal information.
     */
    ...
    /**
     * This is a handle to our chub shading program.
     */
    ...
    public void onSurfaceChanged(GL10 gl10, int width, int height) {
        ...
        // while the width will vary as per aspect radio.
        final float radio = (float) width / height;
        final float left = -radio;
        final float right = radio;
